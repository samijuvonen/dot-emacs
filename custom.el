(custom-set-variables
 ...
 '(elpy-mode-hook
   (quote
    (subword-mode hl-line-mode py-autopep8-enable-on-save)))
 '(elpy-modules
   (quote
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(Info-quoted ((t (:family "Fira Mono")))))
